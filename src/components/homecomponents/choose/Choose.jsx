    ...
    <div className="bg-[#FFFFFF] py-5">
      <div className="text-center">
        ...
        <h2 className="text-3xl font-semibold py-4">
          6 Reasons to Choose Estancy
        </h2>
        <p className="max-w-4xl mx-auto">
          Our real estate website captivates with seamless navigation, stunning
          listings, and user-friendly features—elevating the property search
          experience effortlessly.features—elevating the property search
